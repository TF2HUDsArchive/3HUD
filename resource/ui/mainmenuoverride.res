...
//		"bgcolor_override"	"0 0 0 240"
	...
	"HUDSubtext"
	{
		...
		if_fullmoon
		{
			"labelText"		"Enjoy the full Mo-"
		}
		if_christmas
		{
			"labelText"		"Enjoy the frostbite"
		}
	}
	...
	"SolarTwitchStreamButton"
	{
		...
		// armed style
		"armedBgColor_override"	"SolarMenuBlueTransparent"
	...
	"MOTD_Panel"
	{
		...
		"FaceitText2"
		{
			...
			"visible"	"1"
			"enabled"	"1"
			"labelText"	"Profile of the maker"
			"textAlignment"	"west"
			"wrap"	"1"
			"fgcolor"	"255 255 255 255"
			"font"			"Futura12"
		...
		"FaceitText3"
		{
			...
			"visible"	"1"
			"enabled"	"1"
			"labelText"	"Dont press it 2x if it not shows up (will cause an error)"
			"textAlignment"	"west"
			"wrap"	"1"
			"fgcolor"	"255 255 255 255"
			"font"			"Futura10"
	...
	"Notifications_Panel"
	{
		...
		"Notifications_Scroller"
		{
			...
			"tall"			"135"
			"PaintBackgroundType"	"2"
			"fgcolor_override"	"SolarMenuBlue"
...
//				"tall"					"p0.5"
	...
	"ReportPlayerButton"
	{
		...
		"SubButton"
		{
			...
			"border_armed"		"MainMenuMiniButtonDefault"
			"paintbackground"	"0"
	...
	"OOFButton"
	{
		...
		"brighttext"	"0"
		"default"		"1"
		"Command"		"engine toggleconsole; echo Hi, thanks to download this HUD, i really appreciate that; echo thanks to all people who download this, do not use minmode, you cant see the shield charge; echo Credit Belongs to: SolarLight, Raysfire, And All HUDS.TF discord member, without you all this HUD will never exists"
